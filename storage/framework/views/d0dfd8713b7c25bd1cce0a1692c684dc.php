...
<div class="bg-gradient-to-br from-indigo-500 via-purple-500 to-violet-600 rounded-3xl p-8 md:p-12 mb-8 text-white shadow-xl">
    <div class="flex items-start gap-6">
        ...
        <div class="flex-grow">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($content['badge'])): ?>
...
<?php /**PATH D:\Projects\SloDoks\resources\views/components/material-blocks/intro.blade.php ENDPATH**/ ?>