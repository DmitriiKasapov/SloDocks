<?php $__env->startSection('title', $query ? "Результаты поиска: {$query} — SloDocs" : 'Поиск — SloDocs'); ?>
<?php $__env->startSection('meta_description', $query ? "Найдено результатов по запросу '{$query}' — SloDocs" : 'Поиск по материалам SloDocs'); ?>
    ...
    <div class="text-center mb-8">
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($query): ?>
        <p class="text-white/90 text-lg">
          По запросу: <span class="font-semibold">"<?php echo e($query); ?>"</span>
        </p>
      <?php else: ?>
        <p class="text-white/90 text-lg">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($total > 0): ?>
      ...
      <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-2">
          Найдено результатов: <?php echo e($total); ?>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
          <?php if (isset($component)) { $__componentOriginal66bbad5a58ad3457b4bd68b08aa0ba29 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66bbad5a58ad3457b4bd68b08aa0ba29 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.blocks.service-card','data' => ['service' => $service]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('blocks.service-card'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal66bbad5a58ad3457b4bd68b08aa0ba29)): ?>
<?php $attributes = $__attributesOriginal66bbad5a58ad3457b4bd68b08aa0ba29; ?>
<?php unset($__attributesOriginal66bbad5a58ad3457b4bd68b08aa0ba29); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal66bbad5a58ad3457b4bd68b08aa0ba29)): ?>
<?php $component = $__componentOriginal66bbad5a58ad3457b4bd68b08aa0ba29; ?>
<?php unset($__componentOriginal66bbad5a58ad3457b4bd68b08aa0ba29); ?>
<?php endif; ?>
    ...
    <?php else: ?>
      ...
      <div class="max-w-2xl mx-auto text-center">
        ...
        <p class="text-gray-600 mb-6">
          По запросу <span class="font-semibold">"<?php echo e($query); ?>"</span> не удалось найти подходящих материалов
        </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\SloDoks\resources\views/pages/search.blade.php ENDPATH**/ ?>