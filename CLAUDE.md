...
Работа ведётся согласно инструкциям в папке `/plan`:
- **Концепция и стек** — `/plan/generals/`
- **Текущий план (этап 2)** — `/plan/step2/`
- **Текущие задачи** — `/plan/work.md` ← читать в начале каждой сессии
- **Отчёт о выполнении** — `/plan/ended.md`

**Правило:** после выполнения задачи из `work.md` — сделать краткую запись в `ended.md` (дата, задача, что сделано, статус).
