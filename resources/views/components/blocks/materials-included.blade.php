...
<section class="container-grid my-7.5 md:my-15 {{ $class }}">
    <div class="content">
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            @if($service->materials_included['step_by_step'] ?? false)
            ...
            @if($service->materials_included['documents_list'] ?? false)
                <div class="flex items-start gap-4 p-5 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            @if($service->materials_included['filled_examples'] ?? false)
                <div class="flex items-start gap-4 p-5 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            @if($service->materials_included['practical_tips'] ?? false)
                <div class="flex items-start gap-4 p-5 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            @if($service->materials_included['detailed_info'] ?? false)
                <div class="flex items-start gap-4 p-5 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
